...
class Qwen4ExpQSAFlashAttentionImpl(FlashAttentionImpl):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        # This AMD owner uses FlashAttention only for its paged-cache metadata
        # and reshape-and-cache implementation.  The attention calculation is
        # the portable Triton qsa_sparse_paged_attention kernel below, so it
        # must not require the NVIDIA flash-attn Python extension to import.
...
class Qwen4ExpQSAAttention(Qwen3NextAttention, AttentionLayerBase):
    ...
    def __init__(
        ...
        *,
        ...
        disable_tp = tp_size == 1 and global_tp_size > 1
